...
const BonusCards = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-28 sm:pt-32">
      ...
      >
        <div className="inline-block p-1.5 sm:p-2 px-3 sm:px-4 rounded-full bg-purple-500/10 text-purple-300 mb-4">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs sm:text-sm">Exclusive Member Benefits</span>
          </div>
        </div>
      ...
      <div className="max-w-md mx-auto mb-6 sm:mb-10 px-3">
        <div className="relative">
          <input
            ...
            className="w-full px-3 sm:px-4 py-2.5 rounded-xl bg-white/10 border border-white/20 
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 px-3 
                    sm:gap-4 sm:px-4 md:gap-5 md:px-6 container mx-auto pb-16">
          ...
          >
            ...
            <div className="relative aspect-[4/3]">
              ...
              <div className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 
                ...
                <FaCrown className="text-white text-[10px] sm:text-xs" />
                <span className="text-white font-medium text-[10px] sm:text-xs">Premium</span>
              </div>
            </div>
            ...
            <div className="p-2 sm:p-3 flex-1 flex flex-col space-y-1.5 sm:space-y-2">
              <div>
                <h3 className="text-amber-400 text-[10px] sm:text-xs font-medium tracking-wide uppercase">
                  {offer.organizationName || 'Elite Partner'}
                </h3>
                <h2 className="text-sm sm:text-base font-bold text-white leading-tight line-clamp-2">
                  {offer.title}
                </h2>
              </div>

              <p className="text-gray-300 flex-1 leading-relaxed text-xs sm:text-sm line-clamp-2 sm:line-clamp-3">
                {offer.description}
              </p>
              ...
              <div className="flex items-center justify-between pt-1.5 sm:pt-2 
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] sm:text-xs text-amber-400 uppercase tracking-wider">
                    Investment
                  </span>
                ...
                <a
                  ...
                  className="flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-full 
                           ...
                           transition-all duration-300 text-[10px] sm:text-xs"
                >
