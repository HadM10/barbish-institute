...
import { FaWhatsapp, FaFilter, FaTimes, FaSearch, FaChevronDown, FaClock, FaUser, FaDollarSign, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
    ...
    'Web Development': [
      {
        ...
        fullDescription: "Comprehensive course covering front-end and back-end development with modern technologies. Learn React, Node.js, and more.",
        duration: "12 weeks",
      ...
      },
      {
        ...
        fullDescription: "Master advanced JavaScript concepts and modern development practices.",
        duration: "8 weeks",
    ...
    'Mobile Development': [
      {
        ...
        fullDescription: "Learn to create professional iOS applications using Swift and Xcode.",
        duration: "10 weeks",
      ...
      },
      {
        ...
        fullDescription: "Master Android app development using Kotlin and Android Studio.",
        duration: "10 weeks",
    ...
    'Data Science': [
      {
        ...
        fullDescription: "Learn to analyze and visualize data using Python and popular libraries.",
        duration: "12 weeks",
      ...
      },
      {
        ...
        fullDescription: "Understanding fundamental machine learning concepts and implementations.",
        duration: "14 weeks",
    ...
    'AI & Machine Learning': [
      {
        ...
        fullDescription: "Comprehensive course on deep learning architectures and applications.",
        duration: "16 weeks",
      ...
      },
      {
        ...
        fullDescription: "Learn to create and implement NLP solutions using modern techniques.",
        duration: "12 weeks",
    ...
    'Cloud Computing': [
      {
        ...
        fullDescription: "Comprehensive AWS cloud architecture and implementation course.",
        duration: "14 weeks",
      ...
      },
      {
        ...
        fullDescription: "Learn to develop and deploy applications on Microsoft Azure.",
        duration: "12 weeks",
    ...
    'Cyber Security': [
      {
        ...
        fullDescription: "Learn to protect networks and systems from cyber threats.",
        duration: "12 weeks",
      ...
      },
      {
        ...
        fullDescription: "Master ethical hacking and security assessment techniques.",
        duration: "14 weeks",
    ...
    'UI/UX Design': [
      {
        ...
        fullDescription: "Learn to create beautiful and functional user interfaces.",
        duration: "10 weeks",
      ...
      },
      {
        ...
        fullDescription: "Learn to conduct UX research and create user-centered designs.",
        duration: "12 weeks",
    ...
    'Digital Marketing': [
      {
        ...
        fullDescription: "Learn comprehensive digital marketing strategies and implementation.",
        duration: "8 weeks",
      ...
      },
      {
        ...
        fullDescription: "Learn to create and execute effective social media campaigns.",
        duration: "6 weeks",
    ...
    'Business Analytics': [
      {
        ...
        fullDescription: "Learn to analyze business data and make informed decisions.",
        duration: "10 weeks",
      ...
      },
      {
        ...
        fullDescription: "Learn to analyze and interpret financial data and trends.",
        duration: "12 weeks",
        ...
        >
          ...
          <div className="p-6 h-[calc(420px-192px)] flex flex-col justify-between">
            <div>
              ...
              <p className="text-text/80 mb-4 line-clamp-3">{course.shortDescription}</p>
            </div>
            <button
        ...
        {isExpanded && (
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                <h2 className="text-2xl font-bold text-primary mb-6">{course.title}</h2>
                ...
                <p className="text-text mb-8 leading-relaxed">{course.fullDescription}</p>
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-sky/90 leading-relaxed">
                Choose from our wide range of industry-focused courses designed to help you succeed
              </p>
            </div>
          </div>
        </div>
