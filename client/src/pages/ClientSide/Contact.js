      ...
      <main className="flex-1 relative">
        ...
        <div className="relative z-10 pt-48">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="inline-block p-1.5 md:p-2 px-4 md:px-6 rounded-full bg-blue-500/10 text-blue-300 mb-4 md:mb-6
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm md:text-base text-blue-100/70">{item.content}</p>
                        </div>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  <div className="space-y-3 md:space-y-4">
                    {[
                      ...
                      <div key={index} className="group cursor-pointer">
                        <p className="text-sm md:text-base text-blue-100/70 hover:text-white 
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative">
                  {showSuccess && (
                    ...
                    >
                      ...
                      <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Notification</h3>
                      <div className="text-lg md:text-xl font-semibold mb-2">Message Sent Successfully!</div>
                  ...
                  <div className="group">
                    <label className="text-sm md:text-base text-blue-100/90 mb-1.5 md:mb-2 block">Your Message</label>
                    <textarea
                      name="message"
