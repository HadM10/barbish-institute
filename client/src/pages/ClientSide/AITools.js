    ...
    setMessages([
      {
        type: "ai",
        content:
          "Hello! I'm your AI assistant powered by advanced language models. I can help you with any questions, discussions, or tasks you have in mind. How can I assist you today?",
        timestamp: new Date(),
      },
    ]);
  }, []);
          ...
          messages: [
            {
              role: "system",
              content:
                "You are a helpful, intelligent, and professional AI assistant. Provide detailed, accurate, and helpful responses.",
            },
            {
              role: "user",
              content: message,
